# Example: Apartment with FTX System and Poor Ventilation

## Situation
A tenant in a multi‑dwelling building reports stale air and stuffiness in a 70 m² apartment. The building, constructed in 2015, uses a mechanical supply and exhaust system with heat recovery (FTX). The tenant notices that the bathroom mirror fogs longer than before and that cooking odours linger.

## Likely causes
1. **Dirty filters or heat exchanger** – clogged supply or exhaust filters and a fouled heat exchanger can reduce airflow and heat recovery efficiency.
2. **Imbalanced supply and exhaust flows** – if supply air exceeds exhaust or vice versa, pressure imbalance can reduce effective ventilation.
3. **Blocked or closed vents** – supply diffusers or extract grilles may have been inadvertently closed or obstructed.
4. **Faulty fan or controls** – fan speed may have been reduced due to a control fault or user intervention.
...
## Recommended actions
1. Replace filters and clean heat exchanger.
...
- Safety risk if electrical isolation is not ensured when servicing fans and heat exchanger.
- If CO₂ levels exceed 1 000 ppm after adjustments, further investigation is necessary.

## Questions for precision
- What are the current CO₂ levels in the apartment?
- Have occupants modified any vents or controls?
- When were filters last replaced?
- Is the heat exchanger a rotary or plate type?